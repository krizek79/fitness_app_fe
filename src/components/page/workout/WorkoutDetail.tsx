                ...
                >
                            ...
                            <div className="flex flex-col">
                                ...
                                >
                                    ...
                                    {workout.levelValue && (
                                        <span
                                            className={
                                                "text-secondary font-normal text-2xl"
                                            }
                                        >
                                            ({workout.levelValue})
                                        </span>
                            ...
                            <div className={"flex flex-wrap gap-x-3 gap-y-3"}>
                                <div className="flex flex-col gap-y-1.5">
                                    ...
                                    {workout.tagResponseList.length > 0 && (
                                        ...
                                        >
                                            {workout.tagResponseList.map(
                                                (tag) => (
                                                    <div
                                                        key={tag.id}
                                                        className={
                                                            "flex-shrink-0 text-sm px-3 py-1.5 border border-primary text-secondary " +
                                                            "bg-background"
                                                        }
                                                    >
                                                        {tag.name}
                    ...
                    <div className="flex flex-col md:flex-row gap-x-3 gap-y-3">
                        <button
                            onClick={handleEdit()}
                            className={
                                "flex w-full justify-center gap-x-3 items-center border-2 px-6 py-1.5 border-primary " +
